...
description: "Common issues and solutions when using Crew"
---
...
If you encounter irrecoverable errors and need to completely wipe your Crew database, you can delete the application data directory for your operating system. 
...
After deleting the application data directory, restart Crew to reset with an empty database and default settings.
