...
description: "Complete guide to using the Crew extension with VSCode, Cursor, and Windsurf"
---

The Crew VSCode extension brings task management directly into your IDE, providing seamless integration with logs, diffs, and process monitoring. This extension works with VSCode and popular forks including Cursor and Windsurf.
...
<Card title="VSCode Marketplace" icon="download" href="https://marketplace.visualstudio.com/items?itemName=bloop.vibe-kanban">
  Install the official Crew extension for VSCode
</Card>
...
<Steps>
<Step title="Start a task in Crew">
...
<Step title="Launch IDE integration">
  ...
  <Note>
  The button text will reflect your editor choice configured in Crew settings.
  </Note>
</Step>
...
**Solution**: Ensure you're working within a worktree created by a Crew task.

<Warning>
The extension can only display task information when VSCode is opened in a directory that corresponds to an active Crew task worktree.
</Warning>

**Steps to resolve**:
1. Verify you opened VSCode through the "Open in [IDE]" button from a Crew task
...
**Problem**: The Crew extension doesn't appear in your IDE.
...
<Tip>
**Workflow Optimization**: Always start tasks from the Crew web interface before opening in your IDE to ensure proper context and worktree setup.
</Tip>
